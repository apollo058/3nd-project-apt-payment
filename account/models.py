...
from django.contrip.auth.models import AbstractBaseUser, BaseUserManager, PermissionsMixin

class UserManager(BaseUserManager):
    def create_user(self, unit, password = None, **extra_fields):
        if not unit:
    ...
    def create_superuser(self, unit, password):
...
class User(AbstractBaseUser, PermissionsMixin): # User를 새로 만든다 커스텀
